...
export default class OcppClient extends Client {
  ...
  on(
    ...
    listener: (
      ...
      cb: (response: CancelReservationResponse) => void
    ) => void
  ): this;
  on(
    ...
    listener: (
      ...
      cb: (response: ChangeAvailabilityResponse) => void
    ) => void
  ): this;
  on(
    ...
    listener: (
      ...
      cb: (response: ChangeConfigurationResponse) => void
    ) => void
  ): this;
  on(
    event: 'ClearCache',
    listener: (
      ...
      cb: (response: ClearCacheResponse) => void
    ) => void
  ): this;
  on(
    event: 'ClearChargingProfile',
    listener: (
      request: ClearChargingProfileRequest,
      cb: (response: ClearChargingProfileResponse) => void
    ) => void
  ): this;
  on(
    event: 'DataTransfer',
  ...
  on(
    event: 'GetCompositeSchedule',
    listener: (
      request: GetCompositeScheduleRequest,
      cb: (response: GetCompositeScheduleResponse) => void
    ) => void
  ): this;
  on(
    ...
    listener: (
      ...
      cb: (response: GetConfigurationResponse) => void
    ) => void
  ): this;
  on(
    ...
    listener: (
      ...
      cb: (response: GetDiagnosticsResponse) => void
    ) => void
  ): this;
  on(
    event: 'GetLocalListVersion',
    listener: (
      request: GetLocalListVersionRequest,
      cb: (response: GetLocalListVersionResponse) => void
    ) => void
  ): this;
  on(
    event: 'RemoteStartTransaction',
    listener: (
  ...
  on(
    event: 'RemoteStopTransaction',
    listener: (
      request: RemoteStopTransactionRequest,
      cb: (response: RemoteStopTransactionResponse) => void
    ) => void
  ): this;
  on(
    event: 'ReserveNow',
    listener: (
      ...
      cb: (response: ReserveNowResponse) => void
    ) => void
  ): this;
  on(
    event: 'Reset',
    listener: (
      ...
      cb: (response: ResetResponse) => void
    ) => void
  ): this;
  on(
    event: 'SendLocalList',
    listener: (
      ...
      cb: (response: SendLocalListResponse) => void
    ) => void
  ): this;
  on(
    event: 'SetChargingProfile',
    listener: (
      request: SetChargingProfileRequest,
      cb: (response: SetChargingProfileResponse) => void
    ) => void
  ): this;
  on(
    ...
    listener: (
      ...
      cb: (response: TriggerMessageResponse) => void
    ) => void
  ): this;
  on(
    ...
    listener: (
      ...
      cb: (response: UnlockConnectorResponse) => void
    ) => void
  ): this;
  on(
    ...
    listener: (
      ...
      cb: (response: UpdateFirmwareResponse) => void
    ) => void
  ): this;
  ...
  callRequest(
    request: 'DiagnosticsStatusNotification',
    payload: DiagnosticsStatusNotificationRequest
  ): Promise<DiagnosticsStatusNotificationResponse>;
  callRequest(
    request: 'FirmwareStatusNotification',
    payload: FirmwareStatusNotificationRequest
